...
def safe_llm_processing_example():
    ...
    masked_content, storage_path = pipeline.sanitize_with_session(user_input, session_id)
    ...
    final_response = pipeline.rehydrate_with_session(simulated_llm_response, session_id)
